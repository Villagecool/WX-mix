...
function onCreate()
	--Iterate over all notes
		...
		for i = 0, getProperty('unspawnNotes.length')-1 do
			...
			if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'BendyShadowSplashNote' then
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'BendyShadowSplashNote' and songName ~= 'Last-Reel' and songName ~= 'Despair' then
